    ...
    <>
            ...
            <div className={`${styles["dashboard-table-section-scroll"]}`}>
                <div className={`${styles["dashboard-table-wrapper"]}`}>
                    ...
                    <div className={`${styles["dashboard-table-column"]} ${styles["dashboard-table-column-data"]} d-flex d-align-center`}>      
                        <span className='font-14 f-600 d-flex word-break'>name</span>
                        <span className='font-14 f-500 d-flex'>Brand</span>
                        ...
                        <span className={`cusror-pointer font-14 f-500 d-flex d-align-center d-justify-center text-primary ${styles["dashboard-btns"]}`}>
        ...
        {add && 
            <Modal modalClass="modal-verify">
                <ApprovalModal handler={modalHandler}></ApprovalModal>
            </Modal>
        }
    </>
  )
